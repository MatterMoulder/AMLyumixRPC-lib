...
namespace AMLyumixRPC
{
    ...
    internal class AppleMusicClientScraper {
        ...
        public AppleMusicClientScraper(bool isRunning, string? lastFmApiKey, int refreshPeriodInSec, bool composerAsArtist, string appleMusicRegion, RefreshHandler refreshHandler, Logger? logger = null) {
            ...
            timer = new System.Timers.Timer(refreshPeriodInSec * 1000);
